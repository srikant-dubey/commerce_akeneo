...
/**
 * Class CommerceAkeneoFamilyDrush
...
class CommerceAkeneoFamilyDrush {
   ...
   * {@inheritdoc}
   */
  public function commerce_akeneo_family_drush_command() {
    $commands = array();
   ...
   */
  public function commerce_akeneo_family_drush_import() {
    $args    = drush_get_arguments();
    $options = drush_migrate_get_options();

    $queue_name  = 'commerce_akeneo:family';
    $queues_info = \Drupal::moduleHandler()->invokeAll('queue_info');

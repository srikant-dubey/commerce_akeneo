 ...
 */
class CommerceAkeneoTaxonomyCategoryService extends CommerceAkeneoTaxonomy {
	public function commerce_akeneo_taxonomy_services_category($request) {
	  ...
	  try {
		...
		services_error($e->getMessage(), $e->getCode() ? $e->getCode() : 500);
	  }
	  catch (Exception $e) {
		watchdog_exception('akeneo', $e);
		services_error('Internal Server Error', 500);
	  }

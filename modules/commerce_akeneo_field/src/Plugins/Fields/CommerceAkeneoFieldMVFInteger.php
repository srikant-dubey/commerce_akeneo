...
/**
 * @file
 * Contians Drupal\commerce_akeneo_field\Plugins\Fields\CommerceAkeneoFieldMVFInteger.
 */
 ...
 * @package Drupal\commerce_akeneo_field\Plugins\Fields\CommerceAkeneoFieldMVFInteger
 */
class CommerceAkeneoFieldMVFInteger extends CommerceAkeneoFieldAbstract {
  ...
  public function addFieldMappingToMigrate($migrate, &$source_fields) {
    ...
    elseif ($target_bundle = reset($this->field['settings']['unit']['handler_settings']['target_bundles'])) {
      ...
      $unit_name = Unicode::strtolower($units[$target_bundle]['standard']);
